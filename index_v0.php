...
jQuery(document).ready(function(){
	...
	$("#loadinggif").hide();
    jQuery("#tabs").tabs();
    queryLibrary(0,true,false,false,false);
});
$(function() {  
...
<body>
	...
	<div id="words" class="easyui-dialog" data-options="left:100,top:20">
	...
	<script type="text/javascript" src="dist/ezui/ezuimain_v1_min.js"></script>
